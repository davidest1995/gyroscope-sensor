...
outlier_colunms = list(df.columns[:6])
...
df[outlier_colunms[:3] + ["label"]].boxplot(by="label", figsize=(20,10), layout=(1,3))
df[outlier_colunms[3:] + ["label"]].boxplot(by="label", figsize=(20,10), layout=(1,3))
...
df[outlier_colunms[:3] + ["label"]].plot.hist(by="label", figsize=(20,20), layout=(3,3))
df[outlier_colunms[3:] + ["label"]].plot.hist(by="label", figsize=(20,20), layout=(3,3))
...
dataset, outliers, X_scores = mark_outliers_lof(df, outlier_colunms)
for col in outlier_colunms:
...
dataset, outliers, X_scores = mark_outliers_lof(df[df["label"] == label], outlier_colunms)
for col in outlier_colunms:
    plot_binary_outliers(dataset=dataset, col=col, outlier_col="outlier_lof", reset_index=True)
